...
#> 1. Download eBird species data (whole world, all dates, just specify species) - https://ebird.org/science/use-ebird-data (requires sign up)
#> 2. Download eBird Sampling data (one time download for all runs) 
#> 3. Download elevation data (one time download for all runs)
#> 4. Place the first dataset into a sub-folder named 'input data' within the project's data folder. Place the one
#>    -time downloaded files into a permanent location e.g. in your home directory (this operation only has to
#>    be carried out once).  

#> The following outputs will be generated from this code (within the data folder):
#> 1. A sub-folder named 'output data' with all necessary processed datasets for 
#>    an abundance map to be generated by a further program. 
#> 2. A sub-folder named 'analytics' containing various plots that give insight into
#>    any useful characteristics/trends in the data

#> Project hierarchy before running this code should look like: 
#> R project folder
#>        -> data folder
#>                  -> input data folder
#>                                -> eBird species data
...
#> After running the script the hierarchy will look like: 
#> R project folder
#>        -> data folder
#>                  -> input data folder
#>                                -> eBird species data
